...
MEMORY_CREATION_POLICY_PROMPT = (
    ...
    "To RECALL memories: try search_curated_memory first (fast keyword search). "
    "If it returns nothing, use semantic_memory_search (pgvector meaning-based) "
    "as fallback — it finds concepts, not just keywords. "
