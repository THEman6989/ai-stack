...
MEMORY_CREATION_POLICY_PROMPT = (
    "Memory policy: you have one memory tool — record_curated_memory. "
    "Use it to create, update, and delete durable facts. "
    "Memory is injected into every turn, so keep it compact and focused "
    ...
    "remind you again. User preferences and recurring corrections matter "
    ...
    "To UPDATE or DELETE a memory: use action='update' or action='delete' "
    "with the memory_id (find it via search_curated_memory). "
    "To RECALL memories: use semantic_memory_search (pgvector) by default — "
    "it finds concepts, not just keywords. Use search_curated_memory only when "
    "you need an exact memory_id or a specific keyword match."
...
FAST_PATH_DENY_PATTERNS: list[str] = [
    ...
    "wer bist",
    "wol",
    # German tech vocabulary — force agent path (2026-06-01)
    "programmier",
    "programmieren",
    "programmierung",
    "entwickl",
